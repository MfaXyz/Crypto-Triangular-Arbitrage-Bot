...
Original file is located at
    https://colab.research.google.com/drive/19hk2KWlKthI-9XTpBpRH-RH3HVKRi48e
"""
...
api_key = '62b3be701481b400016d146a'
api_secret = '85bdda52-4850-49c0-8c86-03c32b306e10'
api_passphrase = 'A2a254912345'
...
amount_dict = {
    "USDT": float(user.get_account('627fc901747b4600010694ed')['available']),
    "BTC": float(user.get_account('62822e07a11a330001c6c9b4')['available']),
    'ETH': float(user.get_account('62b3f01dcf97b00001075639')['available'])
}
    ...
    for t_pair in structured_pairs:
        ...
        if len(surface_arb) > 0: 
            ...
            if len(real_rate_arb) != 0:
                ...
                amount_dict['USDT'] = float(user.get_account('627fc901747b4600010694ed')['available'])
                amount_dict['BTC'] = float(user.get_account('62822e07a11a330001c6c9b4')['available'])
                amount_dict['ETH'] = float(user.get_account('62b3f01dcf97b00001075639')['available'])
